...
?>
<p>All right sparky! You've made it through this part of the installation. Graceric can now communicate with your database. If you are ready, time now to <a href="install.php">run the install!</a></p>
<?php
	break;
}
?>
